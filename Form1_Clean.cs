...
//                DetectUSBCardReaders(availablePorts);
//            }
//            else
//            {
...
//                {
//                    LogMessage("  ℹ No obvious USB card readers detected, but COM ports are available");
//                }
//            }
//        }
//        catch (Exception ex)
...
//        LogMessage($"User: {Environment.UserName} (Admin: {IsRunningAsAdministrator()})");
...
//        LogMessage("");
//        LogMessage("1️⃣ IDENTIFY YOUR DEVICE:");
...
//        LogMessage("");
//        LogMessage("2️⃣ COMMON USB-TO-SERIAL CHIPS:");
...
//        LogMessage("");
//        LogMessage("3️⃣ AUTOMATIC DRIVER INSTALLATION:");
...
//        LogMessage("");
//        LogMessage("4️⃣ MANUAL DRIVER INSTALLATION:");
...
//        LogMessage("");
//        LogMessage("5️⃣ VERIFY INSTALLATION:");
